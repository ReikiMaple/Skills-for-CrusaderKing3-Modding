...
[Jump to navigation](https://ck3.paradoxwikis.com/Story_cycles_modding#mw-head) [Jump to search](https://ck3.paradoxwikis.com/Story_cycles_modding#searchInput)
...
## Creating a story cycle\[ [edit](https://ck3.paradoxwikis.com/index.php?title=Story_cycles_modding&veaction=edit&section=1 "Edit section: Creating a story cycle") \| [edit source](https://ck3.paradoxwikis.com/index.php?title=Story_cycles_modding&action=edit&section=1 "Edit section: Creating a story cycle")\]

Story cycles are defined in common/story\_cycles/ folder, in txt files.
...
- `on_owner_death` \- performs effects when the story owner dies (but fires while they are still alive, like on\_death on\_action)
...
Multiple triggered\_effects can be used in one group and multiple effect\_groups in one story cycle.

`first_valid` can also be used to choose one of multiple triggered\_effects, like this:
...
Retrieved from " [https://ck3.paradoxwikis.com/index.php?title=Story\_cycles\_modding&oldid=24141](https://ck3.paradoxwikis.com/index.php?title=Story_cycles_modding&oldid=24141)"
